    ...
    >
      ...
      <div class="form-group">
        ...
        >
          ...
          <option selected="selected" value="600">1 Frame Every 10 min</option>
...
export default {
  ...
  methods: {
    checkForm: function (e) {
      ...
      if (!this.camera) {
        this.errors.push('Camera required.');
      }
      if (!this.from) {
        this.errors.push('From required.');
      }
      if (!this.to) {
        this.errors.push('To required.');
      }
